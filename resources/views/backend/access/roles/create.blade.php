...
@section('page-header')
    <h1>
        Administracion de provedores
        <small>Crear Permiso</small>
    </h1>
@endsection

@section ('breadcrumbs')
    <li><a href="{!!route('backend.dashboard')!!}"><i class="fa fa-dashboard"></i> Panel de contol</a></li>
...
@section('content')
    ...
    {!! Form::open(['route' => 'admin.access.roles.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) !!}
        ...
        <div class="form-group">
            <label class="col-lg-2 control-label">Permisos asociados</label>
            <div class="col-lg-3">
